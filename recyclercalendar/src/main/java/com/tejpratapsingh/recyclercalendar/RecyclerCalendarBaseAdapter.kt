...
abstract class RecyclerCalendarBaseAdapter(
    ...
    var mHandlerThread: MyHandlerThread =
        MyHandlerThread(RecyclerCalendarBaseAdapter::class.java.getSimpleName())
    ...
    abstract fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int, calendarItem: RecyclerCalenderViewItem)
